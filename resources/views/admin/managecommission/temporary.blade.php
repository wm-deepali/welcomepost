...
<div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1>Temproray Deleted</h1>
            </div>
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item"><a href="{{url('manage-commission-setting')}}">Manage Comission</a></li>
                  <li class="breadcrumb-item active">Temproray Deleteted</li>
               </ol>
            </div>
         </div>
      </div>
                  ...
                  <div class="card-body">
                     <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($data['managecommissions'] as $orderDetails)
                           ...
                           <td>
                              ...
                              <td>
                                 <a href="{{url('edit-manage-commission-setting/'.$orderDetails->id)}}"><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
                                  <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#modal-restore{{$orderDetails->id}}"><i class='fas fa-trash-restore-alt'></i></button>
                              ...
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                       ...
                                       <a href="{{route('permanent-delete-manage-commission-setting',$orderDetails->id)}}"><button type="button" class="btn btn-primary">Yes</button></a>
                                    </div>
                                 </div>
                                 <!-- /.modal-content -->
                              </div>
                           ...
                           <div class="modal fade" id="modal-restore{{$orderDetails->id}}">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    <div class="modal-header">
                                       <h4 class="modal-title">Alert</h4>
                                    ...
                                    <div class="modal-footer justify-content-between">
                                       <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                                       <a href="{{route('restore-manage-commission-setting',$orderDetails->id)}}"><button type="button" class="btn btn-primary">Yes</button></a>
                                    </div>
                                 </div>
                                 <!-- /.modal-content -->
                              </div>
