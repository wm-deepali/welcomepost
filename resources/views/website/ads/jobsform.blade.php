            ...
            <div class="col-sm-12 col-md-10 m-auto">
                <div class="add-post-container">
                    ...
                    <div class="add-post-form">
                        <form id="login_form" name="login_form" method="post" action="{{url('edit-post-job-form')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="add-type">
                                ...
                                <div  class="select-add-type">
                                    <button value="Hourly" type="button" class="add-type1 salary_period @if($job->salary_period == 'Hourly') active @endif">Hourly</button>
                                    <button value="Weekly" type="button" class="add-type1 salary_period @if($job->salary_period == 'Weekly') active @endif">Weekly</button>
                                    <button value="Monthly" type="button" class="add-type1 salary_period @if($job->salary_period == 'Monthly') active @endif">Monthly</button>
                                    <button value="Yearly" type="button" class="add-type1 salary_period @if($job->salary_period == 'Yearly') active @endif">Yearly</button>
                                    <input type="hidden" name="salary_period" id="hidden-salary-period" value="{{ $job->salary_period }}">
                                </div>
                            </div>
                            <div class="add-type">
                                ...
                                <div class="select-add-type"  name="position_type" id="prsition_type">
                                    ...
                                    <button value="{{ ucfirst($orderDetail->jobtype) }}" type="button" class="add-type1 position_type @if($job->position_type == ucfirst($orderDetail->jobtype)) active @endif">{{ ucfirst($orderDetail->jobtype)}}</button>
                                    @endforeach
                                    @endif
                                  
                                    <input type="hidden" name="position_type" id="hidden-position-type" value="{{ ucfirst($job->position_type) }}">
                                </div>
                            </div>
                            <div class="add-type">
                                <div class="add-heading">Salary from *</div>
                                <div class="select-add-type">
                                    <input type="number" autocomplete="off" value="{{ $job->salary_from }}" name="salary_from" id="salary_from"class="form-control" placeholder="Enter Salary From*" title="Enter salary from" required="">
                                </div>
                            </div>
                            <div class="add-type">
                                <div class="add-heading">Salary to *</div>
                                <div class="select-add-type">
                                    <input type="number" autocomplete="off" value="{{ $job->salary_to }}" name="salary_to" id="salary_to" class="form-control" placeholder="Enter Salary to*" title="Enter salary to" required="">
                                </div>
                            ...
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    <input type="text" autocomplete="off" name="ad_title" value="{{ $job->ad_title }}" id="ad_title" class="form-control" placeholder="Enter post tittle*" title="Enter post tittle" required="">
                                </div>
                            </div>
                            <div class="add-type">
                                <div class="add-heading"> Description *</div>
                                <div class="select-add-type">
                                    <textarea autocomplete="off" id="description" class="form-control" maxlength="4096" name="description" placeholder="Enter Description" style="height: 96px;">{{ $job->description }}</textarea>
                                ...
                                <div class="select-add-type">
									...
									<div class="upload-photo-cont active" >
										...
										<div class="sing-img-preview" id="OpenImgUpload" type="file">
										    <img style="height:100px;width:100px; margin-top:46px !important;" id="blah" src="{{ $job->image}}" alt="your image"  />
											...
											<span class="text-center" id="addphoto">Add photo</span>
										</div>
									</div>
									<div class="upload-photo-cont" >
										...
										<div class="sing-img-preview"  id="Image_1" type="input">
                                            ...
                                            <span class="text-center" id="addphoto1" style="display:none !important;">Add photo</span>
										</div>
									</div>
									<div class="upload-photo-cont" >
										...
										<div class="sing-img-preview" type="input" id="Image_2">
                                            ...
                                            <span class="text-center" id="addphoto2" style="display:none !important;">Add photo</span>
										</div>
									</div>
									<div class="upload-photo-cont"  >
										...
										<div class="sing-img-preview" type="input" id="Image_3">
                                            ...
                                            <span class="text-center" id="addphoto3" style="display:none !important;">Add photo</span>
										</div>
									</div>
									<div class="upload-photo-cont" >
										...
										<div class="sing-img-preview" type="input" id="Image_4">
                                            ...
                                            <span class="text-center" id="addphoto4" style="display:none !important;">Add photo</span>
										</div>
									</div>
								</div>
                            </div>
                                ...
                                <div class="select-add-type">
                                    ...
                                    <div id="list" class="tab-content current">
                                            ...
                                            <div class="form-group">
                                                <select name="state" id="state" class="form-control chosen-select" style="display: none;">
                                                    ...
                                                    @foreach($state as $key => $orderDetails)
                                                        <option value="{{$orderDetails->id}}" @if($orderDetails->id == $job->state) selected @endif> {{$orderDetails->name}} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="select-add-type">
                                            ...
                                            <div class="form-group">
                                                <select name="city" id="city" class="form-control chosen-select select-box" style="display: none;">
                                                    ...
                                                    <option value="{{$orderDetail->id}}" @if($orderDetail->id == $job->city) selected @endif> {{ucfirst($orderDetail->name)}} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div> 
                                        <div class="select-add-type">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="neibourhood" id="neibourhood" value="{{ $job->neibourhood }}" placeholder="Enter Neighbourhood" class="form-control">
                                    ...
                                    <div id="c-location" class="tab-content">
                                        <div class="live location">
                                            <ul class="list-style-none">
    											...
    											<input type="hidden" class="hidden_city_name" value="{{ @$locationinfo->regionName}}" name="city_name">
...
$('ul.tabs li').click(function(){
    ...
    if(tab_id=='c-location'){
        $('#neibourhood').removeClass("form-control");
    }else{
        $('#neibourhood').addClass("form-control");
    }
