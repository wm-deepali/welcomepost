            ...
            <div class="col-sm-12 col-md-10 m-auto">
                <div class="add-post-container">
                    ...
                    <div class="add-post-form">
                        <form id="login_form" name="login_form" method="post" action="{{url('edit-post-common-forms')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="heading top">
                                <h3><b>Selected category</b></h3>
                                <div class="all-list-bre news-bre x">
                                    <ul>
                            ...
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    <input type="text" autocomplete="off" value="{{ $common->ad_title }}" name="ad_title" id="builduparea"
                            ...
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    <textarea autocomplete="off" id="description" class="form-control" maxlength="4096" name="description" placeholder="Enter Description"
                                    style="height: 96px;" required="">{{ $common->description }}</textarea>
                            ...
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    <input type="text" autocomplete="off" value="{{$common->price }}" name="price" id="price" class="form-control" placeholder="Enter Price *" required="">
                                </div>
                                ...
                                <div class="select-add-type">
									...
									{{--<div class="upload-photo-cont " >
										...
										<div class="sing-img-preview" id="OpenImgUpload" type="file">
										    <img style="height:100px;width:100px;" id="blah" src="{{ $common->image }}" alt="your image"  />
											...
											<input type="file" name="file" id="imgupload" value="{{ $common->image }}" style="display:none;">
											<span class="text-center text-primary">Add photo</span>
										</div>
									</div>--}}
									<div class="upload-photo-cont active" >
										...
										<div class="sing-img-preview"  id="Image_1" type="input">
											...
											<input type="file" name="file1" id="imgupload_1" value="{{ isset($postimage[0]->image) ? $postimage[0]->image : '' }}" style="display:none;">
                                            <span class="text-center text-white">Add photo</span>
										</div>
									</div>
									<div class="upload-photo-cont" >
										...
										<div class="sing-img-preview" type="input" id="Image_2">
											...
											@endif
											 ...
											 <input type="file" name="file2" id="imgupload_2" value="{{ isset($postimage[1]->image) ? $postimage[1]->image : '' }}" style="display:none;">
                                            <span class="text-center text-white" >Add photo</span>
										</div>
									</div>
									<div class="upload-photo-cont"  >
										...
										<div class="sing-img-preview" type="input" id="Image_3">
											...
											@endif
											 ...
											 <input type="file" name="file3" id="imgupload_3" value="{{ isset($postimage[2]->image) ? $postimage[2]->image : '' }}" style="display:none;">
                                            <span class="text-center text-white">Add photo</span>
										</div>
									</div>
									<div class="upload-photo-cont" >
										...
										<div class="sing-img-preview" type="input" id="Image_4">
											...
											@endif
											 ...
											 <input type="file" name="file4" id="imgupload_4" value="{{ isset($postimage[3]->image) ? $postimage[3]->image : '' }}" style="display:none;">
                                            <span class="text-center text-white" >Add photo</span>
										</div>
									</div>
								</div>
                                ...
                                <div class="select-add-type">
                                    ...
                                    <div id="list" class="tab-content current">
                                            ...
                                            <div class="form-group">
                                                <select name="state" id="state" class="form-control chosen-select" style="display: none;">
                                                    ...
                                                    @foreach($state as $key => $orderDetails)
                                                        <option value="{{$orderDetails->id}}" @if($orderDetails->id == $common->state) selected @endif> {{$orderDetails->name}} </option>
                                        ...
                                        <div class="select-add-type">
                                            ...
                                            <div class="form-group">
                                                <select name="city" id="city" class="form-control chosen-select select-box" style="display: none;">
                                                    ...
                                                    <option value="{{$orderDetail->id}}" @if($orderDetail->id == $common->city) selected @endif> {{ucfirst($orderDetail->name)}} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div> 
                                        <div class="select-add-type">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="neibourhood" id="neibourhood" value="{{ $common->neibourhood }}" placeholder="Enter Neighbourhood" class="form-control">
                                    ...
                                    {{--<div class="add-type">
                                        ...
                                        <div class="profile_user">
                                            ...
                                            <div class="select-add-type">
                                                <input type="text" autocomplete="off" name="fullname" id="fullname" class="form-control" title="Enter name"  value="{{ $userinfo->name }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <label class="switch">
