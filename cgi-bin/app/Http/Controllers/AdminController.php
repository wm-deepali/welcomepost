...
class AdminController extends Controller
{
   ...
   public function attachment_email() {
	  ...
	  public function admin_dashboard()
    {
        ...
        $totalWalletamount = WalletAmout::currentMonthWallet()->sum('amount');
        $totalCashfreeAmount = WalletAmout::currentMonthCashfree()->sum('amount');
       return view('admin.dashboard')->with(['customer'=>$customer,'totalWallet'=>$totalWalletamount,'totalCashfree'=>$totalCashfreeAmount]);
    }
	...
	public function ExportProfessional()
  {
	...
	public function storeInfoCard(Request $request){
        ...
        return redirect()->back()->with('success', 'InfoCard created successfully.');
	...
	public function deletep_user($id)
    {
        ...
        DB::table('customer_child')->where('user_id', $userprofile->id)->delete();
