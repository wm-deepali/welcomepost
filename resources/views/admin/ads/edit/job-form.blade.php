            ...
            <div class="container-fluid">
                ...
                <div class="card shadow-sm mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <form id="login_form" name="login_form" method="post" action="{{ url('admin/update-job-form/'.$ad->id) }}"
                            ...
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    ...
                                    <button value="Hourly" type="button"
                                        class="add-type1 salary_period {{ $formData->salary_period == 'Hourly' ? 'active' : '' }}">

                                        Hourly

                                    </button>

                                    <button value="Weekly" type="button"
                                        class="add-type1 salary_period {{ $formData->salary_period == 'Weekly' ? 'active' : '' }}">

                                        Weekly

                                    </button>

                                    <button value="Monthly" type="button"
                                        class="add-type1 salary_period {{ $formData->salary_period == 'Monthly' ? 'active' : '' }}">

                                        Monthly

                                    </button>

                                    <button value="Yearly" type="button"
                                        class="add-type1 salary_period {{ $formData->salary_period == 'Yearly' ? 'active' : '' }}">
                                    ...
                                    @if(isset($jobs))
                                        ...
                                        @foreach($jobs as $orderDetail)
                                            ...
                                            <button value="{{ ucfirst($orderDetail->jobtype) }}" type="button"
                                                class="add-type1 position_type {{ $formData->position_type == ucfirst($orderDetail->jobtype) ? 'active' : '' }}">
                            ...
                            <div class="add-type">
                                ...
                                <input type="number" autocomplete="off" value="{{ $formData->salary_from }}"
                                    name="salary_from" id="salary_from" class="form-control"
                                    placeholder="Enter Salary From*" required>
                            ...
                            <div class="add-type">
                                ...
                                <input type="number" autocomplete="off" value="{{ $formData->salary_to }}" name="salary_to"
                                ...
                                <div class="select-add-type">
                                    ...
                                    <div class="upload-photo-cont" id="image1">
                                        ...
                                        <div class="sing-img-preview" id="Image_1" type="input">
                                            ...
                                            <input type="file" name="file1" id="imgupload_1" value=""
                                                style="display:none;" accept="image/jpeg, image/png">
                                    ...
                                    <div class="upload-photo-cont" id="image2">
                                        ...
                                        <div class="sing-img-preview" type="input" id="Image_2">
                                            ...
                                            <input type="file" name="file2" id="imgupload_2" value=""
                                                style="display:none;" accept="image/jpeg, image/png">
                                    ...
                                    <div class="upload-photo-cont" id="image3">
                                        ...
                                        <div class="sing-img-preview" type="input" id="Image_3">
                                            ...
                                            <input type="file" name="file3" id="imgupload_3" value=""
                                                style="display:none;" accept="image/jpeg, image/png">
                                    ...
                                    <div class="upload-photo-cont" id="image4">
                                        ...
                                        <div class="sing-img-preview" type="input" id="Image_4">
                                            ...
                                            <input type="file" name="file4" id="imgupload_4" value=""
                                                style="display:none;" accept="image/jpeg, image/png">
