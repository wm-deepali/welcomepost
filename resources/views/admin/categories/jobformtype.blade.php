            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
				...
				<div class="form-group ca-sh-user">
                    <select name="salary_period" id="user_type" class="form-control ca-check-plan">
				  ...
				  <div class="form-group ca-sh-user">
                    <select name="position_type" id="prsition_type" class="form-control ca-check-plan">
                  ...
                  <div class="form-group">
                    <input type="text"  name="salary_from" id="salary_from" class="form-control" placeholder="Salary from"  required="" />
                  </div>
				  
				  <div class="form-group">
                    <input type="text"  name="salary_to" id="salary_to" class="form-control" placeholder="Salary to"  required="" />
                  </div>
                 
				 <div class="form-group">
                    <input type="text"  name="ad_title" id="ad_title" class="form-control" placeholder="Ad title"  required="" />
                  </div>
