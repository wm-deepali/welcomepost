...
Route::group(['middleware' => ['adminBasicAuth']], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('ads', [AdsController::class, 'index'])->name('admin.post.index')->middleware('check.subadmin.permission:ads_edit');
        Route::get('/post-ads', [AdsController::class, 'adminPostAdsUser'])->name('admin.post.ads')->middleware('check.subadmin.permission:ads_edit');
        Route::post('/find-customer',[AdsController::class, 'findCustomer'])->name('admin.find.customer')->middleware('check.subadmin.permission:ads_edit');
        Route::post('/create-customer-for-ad', [AdsController::class, 'createCustomerForAd'])->name('admin.create.customer.for.ad');
        Route::post('/render-ad-form', [AdsController::class, 'adminAdForms'])->name('admin.ad.forms')->middleware('check.subadmin.permission:ads_edit');
       
        Route::post('post-job-form', [AdsController::class, 'post_job_form'])->name('admin.post-job-form')->middleware('check.subadmin.permission:ads_edit');
        Route::post('post-mobile-forms', [AdsController::class, 'post_mobile_forms'])->name('admin.post-mobile-forms')->middleware('check.subadmin.permission:ads_edit');
        Route::post('post-vehicle-forms', [AdsController::class, 'post_vehicle_forms'])->name('admin.post-vehicle-forms')->middleware('check.subadmin.permission:ads_edit');
        Route::post('post-property-forms', [AdsController::class, 'post_property_forms'])->name('admin.post-property-forms')->middleware('check.subadmin.permission:ads_edit');
        Route::post('post-common-forms', [AdsController::class, 'post_common_forms'])->name('admin.post-common-forms')->middleware('check.subadmin.permission:ads_edit');
       
        Route::get('view-ad/{id}',[AdsController::class, 'viewAdminAd'])->name('admin.view.ad')->middleware('check.subadmin.permission:ads_edit');
        Route::get('delete-ad/{id}',[AdsController::class, 'deleteAd'])->middleware('check.subadmin.permission:ads_edit');
        Route::get('edit-ad/{id}',[AdsController::class, 'editAd'])->name('admin.edit.ad')->middleware('check.subadmin.permission:ads_edit');
       
        Route::post('update-job-form/{id}',[AdsController::class, 'updateJobForm'])->middleware('check.subadmin.permission:ads_edit');
        Route::post('update-mobile-form/{id}',[AdsController::class, 'updateMobileForm'])->middleware('check.subadmin.permission:ads_edit');
        Route::post('update-vehicle-form/{id}',[AdsController::class, 'updateVehicleForm'])->middleware('check.subadmin.permission:ads_edit');
