            ...
            <div class="container-fluid">
                ...
                <div class="card shadow-sm mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <form id="login_form" name="login_form" method="post" action="{{ url('admin/update-mobile-form/'.$ad->id) }}"
...
<option value="apple"
    {{ ($formData->brands ?? '') == 'apple' ? 'selected' : '' }}>
    Apple
</option>

<option value="samsung"
    {{ ($formData->brands ?? '') == 'samsung' ? 'selected' : '' }}>
    Samsung
</option>

<option value="xiaomi"
    {{ ($formData->brands ?? '') == 'xiaomi' ? 'selected' : '' }}>
    Xiaomi
</option>

<option value="oneplus"
    {{ ($formData->brands ?? '') == 'oneplus' ? 'selected' : '' }}>
    OnePlus
</option>

<option value="realme"
    {{ ($formData->brands ?? '') == 'realme' ? 'selected' : '' }}>
    Realme
</option>

<option value="oppo"
    {{ ($formData->brands ?? '') == 'oppo' ? 'selected' : '' }}>
    Oppo
</option>

<option value="vivo"
    {{ ($formData->brands ?? '') == 'vivo' ? 'selected' : '' }}>
    Vivo
</option>

<option value="nokia"
    {{ ($formData->brands ?? '') == 'nokia' ? 'selected' : '' }}>
    Nokia
</option>

<option value="asus"
    {{ ($formData->brands ?? '') == 'asus' ? 'selected' : '' }}>
    Asus
</option>
                                        </select>
                                    </div>
                            ...
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    <input type="text" autocomplete="off" value="{{ $formData->ad_title }}" name="ad_title"
                                        id="builduparea" class="form-control" placeholder="Enter post tittle*" required="">
                                </div>
                            </div>
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    <textarea autocomplete="off" id="description" class="form-control description-word"
                                        ...
                                        style="height: 96px;" required>{{ $formData->description }}</textarea>
