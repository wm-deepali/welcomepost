          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="{{url('add-formtype')}}"><button type="button" class="btn btn-block bg-gradient-primary">Add Form type</button></a></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach($formtype as $key => $orderDetails)
                  <tr>
                    <td>{{$key + 1}}</td>
                    ...
                    <td>
						...
						<a href="{{url('edit-formtype/'.$orderDetails->id)}}"><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
						...
						<div class="modal-dialog">
						  <div class="modal-content">
							...
							<div class="modal-footer justify-content-between">
							  ...
							  <a href="{{url('delete-formtype/'.$orderDetails->id)}}"><button type="button" class="btn btn-primary">Yes</button></a>
							</div>
						  </div>
						  <!-- /.modal-content -->
						</div>
