            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach($brand as $key => $orderDetails)
                  <tr>
                    <td>{{$key + 1}}</td>
                    ...
                    <td>
						...
						<a href="{{url('edit-brand/'.$orderDetails->id)}}"><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
						...
						<div class="modal-dialog">
						  <div class="modal-content">
							...
							<div class="modal-footer justify-content-between">
							  ...
							  <a href="{{url('delete-brand/'.$orderDetails->id)}}"><button type="button" class="btn btn-primary">Yes</button></a>
							</div>
						  </div>
						  <!-- /.modal-content -->
						</div>
