            ...
            <div class="col-sm-12 col-md-10 m-auto">
                <div class="add-post-container">
                    ...
                    <div class="add-post-form">
                        <form id="login_form" name="login_form" method="post" action="{{url('edit-post-property-forms')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                <button class="add-type1 property_type @if($property->property_type == 'Apartments') active @endif" type="button" value="Apartments">Apartments</button>
                                <button class="add-type1 property_type @if($property->property_type == 'Builder Floors') active @endif" type="button" value="Builder Floors">Builder Floors</button>
                                <button class="add-type1 property_type @if($property->property_type == 'Farm House') active @endif" type="button" value="Farm House">Farm House</button>
                                <button class="add-type1 property_type @if($property->property_type == 'Houses And Villas') active @endif" type="button" value="Houses And Villas">Houses And Villas</button>
                                <input type="hidden" name="property_type" id="hidden-property-type" value="{{ $property->property_type }}">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading">Bedrooms</div>
                            <div class="select-add-type">
                                <button class="add-type1 bedroom @if($property->bedroom == '1') active @endif" type="button"  value="1">1</button>
                                <button class="add-type1 bedroom @if($property->bedroom == '2') active @endif" type="button"  value="2">2</button>
                                <button class="add-type1 bedroom @if($property->bedroom == '3') active @endif" type="button"  value="3">3</button>
                                <button class="add-type1 bedroom @if($property->bedroom == '4') active @endif" type="button" value="4">4</button>
                                <button class="add-type1 bedroom @if($property->bedroom == '4 +') active @endif" type="button"  value="4 +">4+</button>
                                <input type="hidden" name="bedroom" id="hidden-bedroom" value="{{ $property->bedroom }}">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading"> Bathrooms</div>
                            <div class="select-add-type">
                                <button class="add-type1 bathroom @if($property->bathroom == '1') active @endif" type="button" value="1">1</button>
                                <button class="add-type1 bathroom @if($property->bathroom == '2') active @endif" type="button"  value="2">2</button>
                                <button class="add-type1 bathroom @if($property->bathroom == '3') active @endif" type="button"  value="3">3</button>
                                <button class="add-type1 bathroom @if($property->bathroom == '4') active @endif" type="button" value="4">4</button>
                                <button class="add-type1 bathroom @if($property->bathroom == '4 +') active @endif" type="button" value="4 +">4+</button>
                                <input type="hidden" name="bathroom" id="hidden-bathroom" value="{{ $property->bathroom }}">
                            </div>
                        </div>
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                ...
                                <button class="add-type1 residence_status @if($property->residence_status == ucfirst($orderDetail->residencetype)) active @endif" type="button" value="{{ ucfirst($orderDetail->residencetype)}}">{{ ucfirst($orderDetail->residencetype)}}</button>
                                @endforeach
                                @endif
                                
                                <input type="hidden" name="residence_status" id="hidden-residence-status" value="{{ ucfirst($orderDetail->residencetype)}}">
                            </div>
                        </div>
                        ...
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                ...
                                <button class="add-type1 furnishing_status @if($property->furnishing_status == ucfirst($orderDetail->furnishingtype)) active @endif" type="button" value="{{ ucfirst($orderDetail->furnishingtype)}}">{{ ucfirst($orderDetail->furnishingtype)}}</button>
                                @endforeach
                                @endif
                                
                                <input type="hidden" name="furnishing_status" id="hidden-furnishing-status" value="{{ ucfirst($orderDetail->furnishingtype)}}">
                            </div>
                        </div>
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                ...
                                <button  type="button" class="add-type1 construction_status @if($property->construction_status == ucfirst($orderDetail->constructiontype)) active @endif" value="{{ ucfirst($orderDetail->constructiontype)}}">{{ ucfirst($orderDetail->constructiontype)}}</button>
                                @endforeach
                                @endif
                                
                                <input type="hidden" name="construction_status" id="hidden-construction-status" value="{{ ucfirst($orderDetail->constructiontype)}}">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading">Listed by</div>
                            <div class="select-add-type">
                                <button class="add-type1 listed_by @if($property->listed_by == 'Builder') active @endif" type="button" value="Builder" name="listed_by">Builder</button>
                                <button class="add-type1 listed_by @if($property->listed_by == 'Dealer') active @endif" type="button" value="Dealer" name="listed_by">Dealer</button>
                                <button class="add-type1 listed_by @if($property->listed_by == 'Owner') active @endif" type="button" value="Owner" name="listed_by">Owner</button>
                                <input type="hidden" name="listed_by" id="hidden-listed-by" value="{{ $property->listed_by }}">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading">Plot Type</div>
                            <div class="select-add-type">
                                <button class="add-type1 plot_type @if($property->plot_type == 'Residential') active @endif" type="button" value="Residential" name="plot_type">Residential</button>
                                <button class="add-type1 plot_type @if($property->plot_type == 'Commercial') active @endif" type="button" value="Commercial" name="plot_type">Commercial</button>
                                <button class="add-type1 plot_type @if($property->plot_type == 'Agricultural') active @endif" type="button" value="Agricultural" name="plot_type">Agricultural</button>
                                <button class="add-type1 plot_type @if($property->plot_type == 'Industrial') active @endif" type="button" value="Industrial" name="plot_type">Industrial</button>
                                <input type="hidden" name="plot_type" id="hidden-plot-type" value="{{ $property->plot_type}}">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading">Price for Month</div>
                            <div class="select-add-type">
                                <button class="add-type1 price_mention @if($property->price_mention == 'Sell') active @endif" type="button" value="Sell" name="price_mention">Sell</button>
                                <button class="add-type1 price_mention @if($property->price_mention == 'Rent') active @endif" type="button" value="Rent" name="price_mention">Rent</button>
                                
                                <input type="hidden" name="price_mention" id="hidden-price-mention" value="{{$property->price_mention}}">
                            </div>
                        ...
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                <input type="text" autocomplete="off" value="{{ $property->builtup_area }}" name="builtup_area" id="builtup_area"
                                class="form-control" placeholder="Enter Super Builtup Area*" required="">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading">Carpet Area (ft²) *</div>
                            <div class="select-add-type">
                                <input type="text" autocomplete="off"  value="{{ $property->carpet_area }}" name="carpet_area" id="carpet_area" class="form-control" placeholder="Enter Carpet Area*" required="">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading">Maintenance (Monthly)</div>
                            <div class="select-add-type">
                                <input type="text" autocomplete="off" value="{{ $property->maintenance }}" name="maintenance" id="builduparea" class="form-control" placeholder="Enter Maintenance (Monthly)" required="">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading">Total Floors</div>
                            <div class="select-add-type">
                                <input type="text" autocomplete="off" value="{{ $property->total_floor }}" name="total_floor" id="total_floor" class="form-control" placeholder="Enter Total Floors " required="">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading">Floor No</div>
                            <div class="select-add-type">
                                <input type="text" autocomplete="off" value="{{ $property->floor_no }}" name="floor_no" id="floor_no" class="form-control" placeholder="Enter Floor No" required="">
                            </div>
                        </div>
                        <div class="add-type">
                            <div class="add-heading">Car Parking</div>
                            <div class="select-add-type">
                                <button class="add-type1 car_parking @if($property->car_parking == '0') active @endif" type="button" value="0">0</button>
                                <button class="add-type1 car_parking @if($property->car_parking == '1') active @endif" type="button" value="1">1</button>
                                <button class="add-type1 car_parking @if($property->car_parking == '2') active @endif" type="button" value="2">2</button>
                                <button class="add-type1 car_parking @if($property->car_parking == '3') active @endif" type="button" value="3" >3</button>
                                <button class="add-type1 car_parking @if($property->car_parking == '3 +') active @endif" type="button" value="3 +">3+</button>
                                <input type="hidden" name="car_parking" id="hidden-car-parking" value="{{ $property->car_parking }}">
                            </div>
                        </div>
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                <div class="form-group">
                                    <select name="facing" id="user_type"
                                        class="form-control chosen-select" style="display: none;">
                                        <option value="">Select Facing</option>
                                        @foreach($facing as $orderDetail)
                                        <option value="{{ $orderDetail->facingtype}}" @if($property->facing == $orderDetail->facingtype) selected @endif>{{ ucfirst($orderDetail->facingtype) }}</option>
                                        @endforeach
                        ...
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                <input type="text" autocomplete="off" value="{{ $property->project_name }}" name="project_name" id="project-name" class="form-control" placeholder="Enter Project Name" maxlength="70"  required="">
                        ...
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                <input type="text" autocomplete="off" value="{{ $property->ad_title }}" name="ad_title" id="ad_title"
                                    class="form-control" maxlength="70" placeholder="Enter Ad title *" required="">
                                <span class="float-right counter-text"> 
                        ...
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                <textarea autocomplete="off" maxlength="4096" id="description" class="form-control" name="description" placeholder="Enter Description"
                                    style="height: 96px;">{{ $property->description }}</textarea>
                                <span class="float-right counter-text"> 
                        ...
                        <div class="add-type">
                            ...
                            <div class="select-add-type">
                                <input type="text" autocomplete="off" value="{{ $property->price }}" name="price" id="price"
                            ...
                            <div class="select-add-type">
                                ...
                                <div id="list" class="tab-content current">
                                        ...
                                        <div class="form-group">
                                            <select name="state" id="state"
                                                ...
                                                @foreach($state as $key => $orderDetails)
                                                    <option value="{{$orderDetails->id}}" @if($orderDetails->id == $property->state) selected @endif> {{$orderDetails->name}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="select-add-type">
                                        ...
                                        <div class="form-group">
                                            <select name="city" id="city"
                                                class="form-control chosen-select select-box" style="display: none;">
                                                <option value="">Select City</option>
                                                @foreach($city as $key => $orderDetail)
                                                    <option value="{{$orderDetail->id}}" @if($orderDetail->id == $property->city) selected @endif> {{ucfirst($orderDetail->name)}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div> 
                                    <div class="select-add-type">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="neibourhood" id="neibourhood" value="{{ $property->neibourhood }}" placeholder="Enter Neighbourhood" class="form-control">
