        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('post-add-states')}}" role="form" id="quickForm" method="post" enctype="multipart/form-data">
                <div class="card-body">
				
				<div class="form-group">
                    <label>Country</label>
					<select class="select" name="country"  data-placeholder="Select Category" style="width: 100%;">
