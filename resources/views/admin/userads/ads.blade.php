                                          ...
                                          <div class="card-body">
                                             <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                      <td>{{$key + 1}}</td>
                                                      <td><img src="{{ $orderDetails->image }}" class="view-image"  data-ad-id="{{$orderDetails->ad_id}}" style="height:50px;width:50px;"></td>
                                                      @foreach($adImages as $imageAd)
                                                            <img src="{{$imageAd->image}}" class="view-image" data-ad-id="{{$orderDetails->ad_id}}" style="height:0px;width:0px;">
                                                        @endforeach
                                                      ...
                                                      <td>{{$orderDetails->ad_type}}</td>
                                                       <td width="15%">
                                                            <select name="document" onchange="changeState(this, {{ $orderDetails->id }})" id="status{{ $orderDetails->id }}" class="form-control" data-id="{{ $orderDetails->id }}">
                                                         ...
                                                         <form action="{{url('reject-post')}}" role="form" id="quickForm" method="post">
                                                            <div class="modal-content">
                                                               ...
                                                               <div class="modal-body">
                                                                  ...
                                                                  <textarea name="reason" class="form-control" required="" rows="4" style="width:100%;" ></textarea>
                                                               </div>
                                                               <div class="modal-footer justify-content-between">
                                                                  <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                                                    ...
                                                    <table id="example3" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>{{$key + 1}}</td>
                                                                <td>
                                                                    <img src="{{$orderDetails->image}}" style="height:50px;width:50px;" data-ad-id="{{$orderDetails->ad_id}}" class="view-image">
                                                                </td>
                                                                @foreach($adImages as $imageAd)
                                                            <img src="{{$imageAd->image}}" class="view-image" data-ad-id="{{$orderDetails->ad_id}}" style="height:0px;width:0px;">
                                                        @endforeach
                                                                ...
                                                                <td>{{$orderDetails->ad_type}}</td>
                                                                <td width="15%">
                                                                    <select name="document" id="status{{$orderDetails->id}}" class="form-control">
                                                                        <option value="0" @if($orderDetails->status == 0) selected @endif>Pending</option>
                                                                        <option value="1" @if($orderDetails->status == 1) selected @endif>Publish</option>
                                                                        <option value="2" @if($orderDetails->status == 2) selected @endif>Reject</option>
                                                                    </select>
                                                                </td>
                                                            ...
                                                            <div class="modal fade" id="rejectreason{{$orderDetails->id}}">
                                                                <div class="modal-dialog">
                                                                    <form action="{{url('reject-post')}}" role="form" id="quickForm" method="post">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <p>Reason For Rejection?</p>
                                                                                <input type="hidden" name="proff_id" value="{{$orderDetails->id}}">
                                                                                <input type="hidden" name="status" value="2">
