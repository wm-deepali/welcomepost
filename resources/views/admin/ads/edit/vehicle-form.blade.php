            ...
            <div class="container-fluid">
                ...
                <div class="card shadow-sm mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <form id="login_form" name="login_form" method="post" action="{{ url('admin/update-vehicle-form/'.$ad->id) }}"
                                ...
                                <select name="brands" id="brands" class="form-control chosen-select">
                                    ...
                                    @if(isset($brand))
                                        ...
                                        @foreach($brand as $orderDetail)
                                           ...
                                           <option value="{{ ucfirst($orderDetail->name)}}"
    {{ ($formData->brand ?? '') == ucfirst($orderDetail->name) ? 'selected' : '' }}>

                                                {{ ucfirst($orderDetail->name)}}
                            ...
                            <div class="add-type">
                                ...
                                <select name="vehicle_type" id="vehicle_type" class="form-control chosen-select">
                                    ...
                                    @if(isset($vehicleType))
                                        ...
                                        @foreach($vehicleType as $orderDetail)
                                          ...
                                          <option value="{{ ucfirst($orderDetail->type)}}"
    {{ ($formData->vehicle_type ?? '') == ucfirst($orderDetail->type) ? 'selected' : '' }}>

                                                {{ ucfirst($orderDetail->type)}}
                                ...
                                <select name="fuel_type" id="fuel_type" class="form-control chosen-select">
                                    ...
                                    @if(isset($FuelType))
                                        ...
                                        @foreach($FuelType as $orderDetail)
                                            ...
                                            <option value="{{ ucfirst($orderDetail->fuel_type)}}"
    {{ ($formData->fuel_type ?? '') == ucfirst($orderDetail->fuel_type) ? 'selected' : '' }}>

                                                {{ ucfirst($orderDetail->fuel_type)}}
                            ...
                            <div class="add-type">
                                ...
                                <select name="transmission" id="transmission" class="form-control chosen-select">
                                    ...
                                    @if(isset($transmission))
                                        ...
                                        @foreach($transmission as $orderDetail)
                                            ...
                                            <option value="{{ ucfirst($orderDetail->transmission)}}"
    {{ ($formData->transmission ?? '') == ucfirst($orderDetail->transmission) ? 'selected' : '' }}>

                                                {{ ucfirst($orderDetail->transmission)}}
                            ...
                            <div class="add-type">
                                ...
                                <input type="text" autocomplete="off" name="year" id="year" class="form-control"
                                   value="{{ $formData->year }}" placeholder="Enter Year">
                            ...
                            <div class="add-type">
                                ...
                                <input type="text" autocomplete="off" name="km" id="km" class="form-control"
                                    value="{{ $formData->km }}" placeholder="Enter KM Driven">
                            ...
                            <div class="add-type">
                                ...
                                <input type="text" autocomplete="off" value="{{ $formData->ad_title }}" name="ad_title"
                            ...
                            <div class="add-type">
                                ...
                                <textarea autocomplete="off" id="description" class="form-control description-word"
                                    maxlength="4096" name="description" placeholder="Enter Description"
...
@endif
                    ...
                    <input type="hidden" name="email" id="email" class="form-control" value="{{$userinfo->email}}"
                        required="" />
                    <input type="hidden" name="fullname" id="fullname" class="form-control" value="{{$userinfo->name}}"
                        required="" />
                    <input type="hidden" name="mobile" id="mobile" class="form-control" value="{{$userinfo->mobile}}" />

                    <input type="hidden" name="location" id="location" class="form-control" value="{{$userinfo->address}}"
                        required="" />
                    ...
                    <input type="hidden" name="formtype" id="location" class="form-control" value="{{$form_id}}"
                        required="" />
                    <input type="hidden" name="category_id" id="location" class="form-control" value="{{$categoryid}}"
                        required="" />
