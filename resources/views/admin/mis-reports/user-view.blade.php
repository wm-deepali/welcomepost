        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">User's View</li>
            </ol>
          </div> 
        </div>
      </div><!-- /.container-fluid -->
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-12">
                                           <div class="card">
                                                <div class="card-body">
                                                    <table id="examples11Table" class="table table-bordered table-striped mis-table">
                                                        <thead>
                                                            <tr>
                                                              <th>Date</th>
                                                              <th>User ID</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$view->subscriptionhistory->customers->member_id}}</td>
                                                                <td>{{$view->subscriptionhistory->customers->email}}</td>
                                                                <td>{{$view->subscriptionhistory->subscription_number}}</td>
                                                                <td>{{$view->ad_view_count??"N/A"}}</td>
                                                                <td>{{$view->subscriptionhistory->type}}</td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
                                                        <tfoot>
