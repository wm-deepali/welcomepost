			...
			<div class="col-sm-12 col-md-10 m-auto">
				<div class="add-post-container">
					...
					<div class="add-post-form">
						<form id="login_form" name="login_form" method="post" action="{{url('post-vehicle-forms')}}" enctype="multipart/form-data">
							@csrf
                    ...
                    >
											...
											<option value="{{ ucfirst($orderDetail->name)}}">{{ ucfirst($orderDetail->name)}}</option>
											@endforeach
											@endif
							...
							<div class="add-type">
								...
								<div class="select-add-type">
									<div class="form-group">
										<select name="vehicle_type" id="vehicle_type"class="form-control chosen-select" style="display: none;">
											<option value="">Select Vehicle Type</option>
											@if(isset($vehicleType))
											@foreach($vehicleType as $orderDetail)
											<option value="{{ ucfirst($orderDetail->type)}}">{{ ucfirst($orderDetail->type)}}</option>
											@endforeach
											@endif
							...
							<div class="add-type">
								...
								<div class="select-add-type">
									<div class="form-group">
										<select name="fuel_type" id="fuel_type"class="form-control chosen-select" style="display: none;">
											<option value="">Select Fuel Type</option>
											@if(isset($FuelType))
											@foreach($FuelType as $orderDetail)
											<option value="{{ ucfirst($orderDetail->fuel_type)}}">{{ ucfirst($orderDetail->fuel_type)}}</option>
											@endforeach
											@endif
							...
							<div class="add-type">
								...
								<div class="select-add-type">
									<div class="form-group">
										<select name="transmission" id="transmission"class="form-control chosen-select" style="display: none;">
											<option value="">Select Transmission</option>
											@if(isset($transmission))
											@foreach($transmission as $orderDetail)
											<option value="{{ ucfirst($orderDetail->transmission)}}">{{ ucfirst($orderDetail->transmission)}}</option>
											@endforeach
											@endif
							...
							<div class="add-type">
								...
								<div class="select-add-type">
									<input type="text" autocomplete="off" name="year" id="year" class="form-control" placeholder="Enter Year*" value="{{ old('year') }}" required="">
								</div>
							</div>
							<div class="add-type">
								<div class="add-heading"> KM Driven</div>
								<div class="select-add-type">
									<input type="text" autocomplete="off" name="km" id="builduparea"class="form-control" value="{{ old('km') }}" placeholder="Enter KM Driven*" title="Enter KM Driven" required="">
								</div>
							</div>
							<div class="add-type">
								...
								<div class="select-add-type">
									...
									class="form-control" placeholder="Enter Tittle*" value="{{ old('ad_title') }}" required="">
								</div>
							</div>
							<div class="add-type">
								<div class="add-heading"> Description *</div>
								<div class="select-add-type">
									<textarea autocomplete="off" maxlength="4096" id="description" class="form-control" maxlength="4096" name="description" placeholder="Enter Description" style="height: 96px;" required>{{ old('description') }}</textarea>
									<span class="float-right counter-text"> 
										<span id="counter-display" class="tag is-success">0</span>
									</span>
								</div>
							</div>
							<hr class="add-post-hr">
							<div class="add-type">
								...
								<div class="select-add-type">
									<input type="text" autocomplete="off" name="price" id="price" value="{{ old('price') }}" class="form-control" placeholder="Enter Price *" required="">
								</div>
