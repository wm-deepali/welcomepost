...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Reserve Seeds Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">MIS-Report</li>
              <li class="breadcrumb-item active">Reserve Seeds</li>
            </ol>
          </div> 
        </div>
      </div><!-- /.container-fluid -->
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-12">
                                               <div class="card">
                                                    <div class="card-body">
                                                        <table id="examples3Table" class="table table-bordered table-striped">
                                                            <thead>
                                                               <tr>
                                                                  <th>Sr</th>
                                                                  <th>Seed ID(Customer ID)</th>
                                                                  <th>Email</th>
                                                                  <th>Reserv Date</th>
                                                               </tr>
                                                            </thead>
                                                            <tbody>
                                                                ...
                                                                @if($data->reserve_expiry_at==null&&$data->parent_id==null)
                                                                @php
                                                                    $user_reserved = App\Models\Customer_child::where('child_id',$data->id)->orderBy('created_at','DESC')->first();
                                                                @endphp
                                                                <tr>
                                                                    <td>{{$count++}}</td>
                                                                    <td>{{$data->member_id}}</td>
                                                                    <td>{{$data->email}}</td>
                                                                    <td>{{$user_reserved->removal_date ?? $data->created_at}}</td>
                                                                </tr>
                                                                @endif
                                                                @endforeach
                                                            </tbody>
