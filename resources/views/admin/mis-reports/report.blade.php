...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Referral Link Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">MIS-Report</li>
              <li class="breadcrumb-item active">Referral Link Report</li>
            </ol>
          </div> 
        </div>
      </div><!-- /.container-fluid -->
                                                   ...
                                                   <table id="examples1Table" class="table table-bordered table-striped mis-table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$data->customerallchild->count()}}</td>
                                                                <td>{{$data->subscriptionhistory[0]->auto_join_member ?? 0}}</td>
