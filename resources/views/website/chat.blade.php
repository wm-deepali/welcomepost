...
<section class="news-hom-big news-details">
    <div class="container">
        <div class="user-chatting-page-desktop-view">
            <div class="card mb-5">
	            <div class="row g-0">
	            	...
	            	<div class="col-12 col-lg-7 col-xl-9">
        				...
        				@endphp
                        <div class="right-side-chat tab @if($max_id == $id) tab-active @endif " id="tab<?php echo $orderDetails->id; ?>" data-id="tab<?php echo $orderDetails->id; ?>">
                            <div class="py-2 px-4 border-bottom d-block">
                                ...
                                <div class="d-flex align-items-center py-1">
                                    <div class="position-relative">
                                        <img src="{{$result[0]->image}}" class="rounded-circle mr-1" alt="{{$result[0]->name}}" width="40" height="40">
                                    </div>
            ...
            //                 console.log(consumer_id, reciever_id , user_id , is_admin)
            ...
            //                         $('#'+tabId+' .chat-messages').html(data);
            //                     }
            //                 });
            //             }
            //             var tabId = $('.right-side-chat.tab-active').attr('id');
            //             setInterval(function() {
            //                 reloadPage(tabId); // Reload chat messages every 8 seconds
            //             }, 8000);
