            ...
            <div class="col-sm-12 col-md-10 m-auto">
                <div class="add-post-container">
                    ...
                    <div class="add-post-form">
                        <form id="login_form" name="login_form" method="post" action="{{url('edit-post-mobile-forms')}}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="select-add-type">
                                    <div class="form-group">
                                        <select name="brands" id="brands" class="form-control chosen-select" style="display: none;">
                                            ...
                                            @foreach($mobilebrand as $orderDetail)
                                            <option value="{{ $orderDetail->name }}" @if($orderDetail->name == $mobile->brands) selected @endif>{{ $orderDetail->name }}</option>
                                            @endforeach
                                            @endif
                            ...
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    <input type="text" autocomplete="off" value="{{ $mobile->ad_title }}" name="ad_title" id="builduparea" class="form-control" placeholder="Enter post tittle*" required="">
                                </div>
                            </div>
                            <div class="add-type">
                                <div class="add-heading">Description *</div>
                                <div class="select-add-type">
                                    <textarea autocomplete="off" id="description" class="form-control description-word" maxlength="4096" name="description" placeholder="Enter Description" style="height: 96px;" required>{{ $mobile->description }}</textarea>
                            ...
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    <input type="text" autocomplete="off" value="{{ $mobile->price }}" name="price" id="price" class="form-control" placeholder="Enter Price *" required="">
                                </div>
                                ...
                                <div class="select-add-type">
									...
									<div class="upload-photo-cont active" >
										...
										<div class="sing-img-preview" id="OpenImgUpload" type="file">
										    <img style="height:100px;width:100px;" id="blah" src="{{ $mobile->image }}" alt="your image"  />
                                ...
                                <div class="select-add-type">
                                    ...
                                    <div id="list" class="tab-content current">
                                            ...
                                            <div class="form-group">
                                                <select name="state" id="state" class="form-control chosen-select" style="display: none;">
                                                    ...
                                                    @foreach($state as $key => $orderDetails)
                                                        <option value="{{$orderDetails->id}}" @if($orderDetails->id == $mobile->state) selected @endif> {{$orderDetails->name}} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="select-add-type">
                                            ...
                                            <div class="form-group">
                                                <select name="city" id="city" class="form-control select-box chosen-select" style="display: none;">
                                                    <option value="">Select City</option>
                                                    @foreach($city as $key => $orderDetail)
                                                    <option value="{{$orderDetail->id}}" @if($orderDetail->id == $mobile->city) selected @endif> {{ucfirst($orderDetail->name)}} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div> 
                                        <div class="select-add-type">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="neibourhood" id="neibourhood" value="{{ $mobile->neibourhood }}" placeholder="Enter Neighbourhood" class="form-control">
...
<script>
var maxLength = 4096;
$('.description-word').keyup(function() {
