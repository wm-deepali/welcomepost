        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Zip</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('post-add-zip')}}" role="form" id="quickForm" method="post" enctype="multipart/form-data">
                <div class="card-body">
				@csrf
			...
			$('#city').html(data);
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="zip" class="form-control" placeholder="Enter Name">
                  </div>
