            ...
            <div class="col-sm-12 col-md-10 m-auto">
                <div class="add-post-container">
                    ...
                    <div class="add-post-form">
                        <form id="login_form" name="login_form" method="post" action="{{url('post-common-forms')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    ...
                                    class="form-control" value="{{ old('ad_title') }}" placeholder="Enter Title*" required="">
                                </div>
                            </div>
                            <div class="add-type">
                                ...
                                <div class="select-add-type">
                                    ...
                                    <div id="list" class="tab-content current">
                                        ...
                                        <div class="select-add-type">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="neibourhood" value="{{old('neibourhood')}}" id="neibourhood" placeholder="Enter Neighbourhood" class="form-control">
